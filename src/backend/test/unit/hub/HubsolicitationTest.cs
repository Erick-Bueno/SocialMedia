...
public class HubsolicitationTest
{
    ...
    public async void should_send_request_to_requester_when_addrequest_returns_false()
    {
        ...
        var hubSolicitation = new HubSolicitation(requestServiceMock.Object, userServiceMock.Object, friendsRepository.Object);
    ...
    [Fact]
    public async void should_send_request_error()
    {
        var requestServiceMock = new Mock<IRequestService>();
        var userServiceMock = new Mock<IUserService>();
        //simulando cliente
        ...
        friendsRepository.Setup(fr => fr.checkIfAreFriends(requestDto.receiverId,requestDto.requesterId)).Returns(friendsModel);
        ...
        await hubSolicitation.sendingRequest(requestDto.receiverId, requestDto.requesterId, StatusEnum.pending);
    ...
    public async void should_request_to_receiver_when_receiver_are_in_usersconnecteds()
    {
        ...
        HubSolicitation hubSolicitation = new HubSolicitation(requestServiceMock.Object, userserviceMock.Object, friendsRepository.Object);
